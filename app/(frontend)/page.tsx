        ...
        <div className="relative max-w-7xl mx-auto px-6 pt-32 pb-20">
          <div className="grid lg:grid-cols-2 ">
            ...
            <div className="text-white">
              ...
              <p className="hero-description text-xl text-gray-100 leading-relaxed mb-8 max-w-2xl">
              ...
              <div className="hero-stats grid grid-cols-3 gap-6 pt-8 border-t border-white/20">
                <div>
                  ...
                  <div className="text-gray-100 text-sm">Countries Served</div>
                </div>
                <div>
                  <div className="text-2xl font-bold text-yellow-400 stat-number">
                    1000
                  </div>
                  <div className="text-gray-100 text-sm">Happy Clients</div>
                </div>
                <div>
                  <div className="text-2xl font-bold text-yellow-400">24/7</div>
                  <div className="text-gray-100 text-sm">Support</div>
                </div>
              </div>
            </div>

            {/* Hero Image - Optional additional content on right side */}
            <div className="relative">
              <div className="hero-image relative z-10"></div>
            </div>
          </div>
        </div>
